      ...
      <div className="p-4 border-b border-zinc-800/50 flex flex-wrap items-center gap-4 bg-zinc-900/50">
        <div className="relative flex-1 max-w-md">
          <Input
            ...
            className="bg-zinc-950 border-zinc-800 focus:border-primary pl-10"
          />
        ...
        <select
          ...
          className="bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-zinc-300 outline-none focus:border-primary"
        >
