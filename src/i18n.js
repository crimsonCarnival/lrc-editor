...
const resources = {
  en: {
    translation: {
      ...
      pasteLyricsPlaceholder: 'Paste your lyrics here, one line per line...',
  ...
  es: {
    translation: {
      ...
      pasteLyricsPlaceholder: 'Pega tus letras aquí, línea por línea...',
  ...
  ja: {
    translation: {
      ...
      pasteLyricsPlaceholder: 'ここに歌詞を貼り付けます（1行ずつ）...',
      startSyncing: '同期を開始 ',
      importFile: 'インポート ',
      mark: 'マーク',
      undo: '元に戻す',
