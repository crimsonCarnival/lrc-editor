    ...
    <>
      <div className="flex flex-row gap-2 pt-2 border-t border-zinc-800/50 overflow-x-auto items-center">
        ...
        >
          ...
          <span className="text-xs sm:text-sm">{t('editor.mark')}</span>
        ...
        {settings.editor?.showShiftAll && (
          <div className="flex items-center gap-2 ml-auto">
            ...
            <span className="text-xs text-zinc-500 whitespace-nowrap flex-shrink-0 hidden md:inline">{t('editor.shiftAll')}</span>
            <NumberInput
              step={0.1}
              value={offsetValue}
